...
<template>
  <main>
  <SectionWrap small class="bg-white">
    <div class="listing listing--one grid">
      <ListItem>
        <CardBioHeader name="John longnamer-Smith" title="Vice-Chancellor" thumb="https://randomuser.me/api/portraits/lego/2.jpg">
  ...
  <SectionWrap small class="bg-alt">
