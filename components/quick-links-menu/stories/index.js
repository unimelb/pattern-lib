...
import QuickLinksAlternateStory2Condensed from './QuickLinksAlternateStory2Condensed.vue';
...
storiesOf('Quick Link Menu', module)
  ...
  .add('Condensed variant', createStory(QuickLinksCondensed))
  .add('Alternate B', createStory(QuickLinksAlternateStory1))
  .add('Alternate C', createStory(QuickLinksAlternateStory2))
  .add('Alternate C (condensed)', createStory(QuickLinksAlternateStory2Condensed))
