...
import QuickLinksPad from './QuickLinksPad.vue';
...
import SecondaryInPrimary from './SecondaryInPrimary.vue';

storiesOf('Quick Link Menu', module)
  .add('Default', createStory(QuickLinksDefault))
  .add('Default (Pad top)', createStory(QuickLinksPad))
  ...
  .add('Secondary option in menu', createStory(SecondaryInPrimary));
