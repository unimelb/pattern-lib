<template>
  <SectionTwoCol direction="left">
    <div slot="main">
      ...
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut numquam ex perspiciatis harum amet laudantium sint error vitae exercitationem sapiente a nisi debitis ipsum sed voluptates natus, esse aut modi.</p>
      <ul>
        <li>Omnis quis dolore ea nostrum reiciendis consequatur.</li>
        <li>Cum omnis ut sequi.</li>
        <li>Et totam ducimus voluptas ab.</li>
        <li>Quos quia nesciunt libero impedit.</li>
        <li>Rerum sunt quis placeat id et eligendi.</li>
      </ul>
    </div>
    <div slot="side">
      <FigureWrap>
