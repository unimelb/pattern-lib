<template>
    <section-wrap class="bg-white">
      <welcome name="Professor Glynn Davis" title="Vice Chancellor" caption-text="The Vice-Chancellor is the Chief Executive Officer of the University." btn-text="Bio and Recent Publications">
