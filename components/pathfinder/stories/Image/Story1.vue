<template>
  <SectionWrap class="bg-alt">
    <div class="listing grid">
      ...
      <ListItem class="cell--desk-1of3">
        <CardImage thumb="http://via.placeholder.com/600x200" title="Melbourne model" >
          Check out how our degrees are structured to give our students flexibility and focus.
        </CardImage>
      </ListItem>
      <ListItem class="cell--desk-1of3">
        <CardImage thumb="http://via.placeholder.com/300x200" title="Our structure">
          this is a test of the content
        </CardImage>
      </ListItem>
      <ListItem class="cell--desk-1of3">
        <CardImage thumb="http://via.placeholder.com/550x200" title="Governance">
          this is a test of the content
        </CardImage>
      </ListItem>
      <ListItem class="cell--desk-1of3">
        <CardImage thumb="http://via.placeholder.com/400x200" title="Annual reports" >
